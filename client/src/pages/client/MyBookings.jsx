...
import { Calendar, Users, FileText, Landmark, Clock, CheckCircle, XCircle, ArrowLeft, Loader2, RefreshCw } from 'lucide-react';
            ...
            <main className="max-w-5xl mx-auto px-4 md:px-6 pb-16">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Theo dõi, kiểm tra trạng thái và lịch trình các tour du lịch của bạn</p>
                    </div>
                    <button 
