...
const ClientFooter = () => (
    <footer className="bg-[#1a1a1a] text-gray-200 mt-20 pt-12 pb-6">
        ...
        <div className="max-w-7xl mx-auto border-t border-[#332222] mt-10 pt-4 px-4 text-gray-500 text-xs tracking-wide flex flex-col md:flex-row md:justify-between md:items-center gap-2">
