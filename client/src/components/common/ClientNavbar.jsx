        ...
        <header className="fixed top-0 left-0 w-full bg-white shadow z-30">
            <div className="max-w-7xl mx-auto flex items-center justify-between h-16 px-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="hidden md:block bg-[#8B1A1A] text-white px-5 py-2 rounded-full font-semibold shadow hover:bg-[#a83232] transition">
                        Đăng nhập
                    </button>
                    {/* Mobile toggle */}
                    <button
            ...
            {mobileOpen && (
                <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-4">
                    ...
                    <button className="w-full bg-[#8B1A1A] text-white py-2 rounded-full font-semibold hover:bg-[#a83232] transition">
                        Đăng nhập
                    </button>
                </div>
            )}
