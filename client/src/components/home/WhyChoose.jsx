...
const whyItems = [
    {
        icon: <Headphones className="w-7 h-7 text-[#8B1A1A]" />, title: "Hỗ trợ 24/7",
        desc: "Đội ngũ tư vấn nhiệt tình, sẵn sàng hỗ trợ bạn mọi lúc mọi nơi trong suốt hành trình."
    },
    {
        icon: <BadgeDollarSign className="w-7 h-7 text-[#8B1A1A]" />, title: "Giá tốt nhất",
        desc: "Cam kết giá cạnh tranh nhất thị trường cùng nhiều ưu đãi hấp dẫn dành riêng cho thành viên."
    },
    {
        icon: <ShieldCheck className="w-7 h-7 text-[#8B1A1A]" />, title: "Thanh toán an toàn",
...
const WhyChoose = () => (
    <section className="max-w-7xl mx-auto mt-32 px-4">
        <div className="flex flex-col items-center mb-10">
            ...
            <span className="block h-1 w-16 bg-[#8B1A1A] rounded mt-4 mb-2"></span>
        </div>
